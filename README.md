...
**Release candidate: `v0.1.3` (подготовка релиза).** Основные R0/MVP-потоки фаз 3, 4, 5, 6, 8 и 9 реализованы. `v0.1.1` закрыл 21 P0 первого аудита, `v0.1.2` — 4 P1 и 5 P2 повторного ревью. Текущая patch-итерация устраняет release/documentation drift и проверяет канонический GitHub/CI gate.
