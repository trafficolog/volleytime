...
status_note: 'Production deployment still follows main; implementation must establish an explicit main-to-prod promotion boundary before the first VPS release.'
roles:
  - DEVOPS
  - QA
depends_on:
...
5. Focused test и обязательный repository gate проходят до merge/promotion.
