...
> **Дополнение 2026-09-24:** новый архив дизайн-референса v2 разобран в [карте MVP-экранов](../../design/2026-09-23-reference-v2.md), а визуальная миграция запланирована отдельными SDD-карточками в R0.6 `v0.1.6`. Перед Mini App игрока добавлена задача 5.13.21 по опциональным абонементам организации; она пока не реализована. Эта запись фиксирует план, **не** подтверждает реализацию UI, прохождение визуального QA или production deploy. Снимок ниже исторический и требует отдельной общей сверки статуса.
