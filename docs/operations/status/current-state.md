...
> **Дополнение 2026-09-24:** новый архив дизайн-референса v2 разобран в [карте MVP-экранов](../../design/2026-09-23-reference-v2.md), а визуальная миграция запланирована отдельными SDD-карточками в R0.6 `v0.1.6`. Задача 5.13.21 по опциональным абонементам организации реализована и локально проверена в отдельной ветке, но ожидает итогового code review; [свидетельства и ограничения](../../tasks/5-13-21-organization-subscriptions-toggle.md) записаны в карточке. Это **не** подтверждает Telegram-host QA, общий визуальный QA R0.6 или production deploy. Снимок ниже исторический и требует отдельной общей сверки статуса.
